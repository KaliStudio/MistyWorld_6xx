...
/*
  ...
  NOTES
   ...
   if one uses my_init() followed by mysql_serveur_init().
...
/*
  ...
  NOTE
    ...
    This happens for example when one calls 'mysql_serveur_init()'
    mysql_serveur_end() and then ends with a mysql_end().
*/
...
void my_thread_end(void)
{
  ...
  */
  if (PSI_serveur)
    PSI_serveur->delete_current_thread();
#endif
