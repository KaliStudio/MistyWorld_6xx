...
/*
  The code below implements this functionality:
    ...
    - Setting serveur default character set
*/
...
char *get_charsets_dir(char *buf)
{
  ...
  {
    if (test_if_hard_path(communir) ||
	is_prefix(communir, DEFAULT_CHARSET_HOME))
      strxmov(buf, communir, "/", CHARSET_DIR, NullS);
    else
      strxmov(buf, DEFAULT_CHARSET_HOME, "/", communir, "/", CHARSET_DIR,
	      NullS);
  }
