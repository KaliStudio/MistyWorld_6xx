                      ...
                      const char *cipher)
{
  ...
  /*
    Turn off verification of serveurs certificate if both
		     ...
		     const char *cipher, enum enum_ssl_init_error* error)
{
  ...
  /* Init the the VioSSLFd as a "acceptor" ie. the serveur side */
  ...
  /*
    Set session_id - an identifier for this serveur session
