...
{ "ER_OUTOFMEMORY", 1037, "Out of memory; restart serveur and try again (needed %d bytes)" },
{ "ER_OUT_OF_SORTMEMORY", 1038, "Out of sort memory; increase serveur sort buffer size" },
...
{ "ER_UDF_NO_PATHS", 1124, "No paths allowed for commun library" },
{ "ER_UDF_EXISTS", 1125, "Function \'%-.192s\' already exists" },
{ "ER_CANT_OPEN_LIBRARY", 1126, "Can\'t open commun library \'%-.192s\' (errno: %d %-.128s)" },
...
{ "ER_HOST_NOT_PRIVILEGED", 1130, "Host \'%-.64s\' is not allowed to connect to this MySQL serveur" },
...
{ "ER_SYNTAX_ERROR", 1149, "You have an error in your SQL syntax; check the manual that corresponds to your MySQL serveur version for the right syntax to use" },
...
{ "ER_BAD_SLAVE", 1200, "The serveur is not configured as slave; fix in config file or with CHANGE MASTER TO" },
...
{ "ER_NOT_SUPPORTED_AUTH_MODE", 1251, "Client does not support authentication protocol requested by serveur; consider upgrading MySQL client" },
...
{ "ER_OPTION_PREVENTS_STATEMENT", 1290, "The MySQL serveur is running with the %s option so it cannot execute this statement" },
...
{ "ER_RESERVED_SYNTAX", 1382, "The \'%-.64s\' syntax is reserved for purposes internal to the MySQL serveur" },
...
{ "ER_LOGGING_PROHIBIT_CHANGING_OF", 1387, "Binary logging and replication forbid changing the global serveur %s" },
...
{ "ER_FOREIGN_SERVER_EXISTS", 1476, "The foreign serveur, %s, you are trying to create already exists." },
{ "ER_FOREIGN_SERVER_DOESNT_EXIST", 1477, "The foreign serveur name you are trying to reference does not exist. Data source error:  %-.64s" },
...
{ "ER_RBR_NOT_AVAILABLE", 1574, "The serveur was not built with row-based replication" },
...
{ "ER_EVENTS_DB_ERROR", 1577, "Cannot proceed because system tables used by Event Scheduler were found damaged at serveur start" },
...
{ "ER_SLAVE_IGNORE_SERVER_IDS", 1650, "The requested serveur id %d clashes with the slave startup option --replicate-same-serveur-id" },
{ "ER_QUERY_CACHE_DISABLED", 1651, "Query cache is disabled; restart the serveur with query_cache_type=1 to enable it" },
