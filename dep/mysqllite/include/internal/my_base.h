...
/*
  ...
  This flag is internal to the MySQL serveur by design. It is not supposed
...
/*
  assuming the table keeps commun actual copy of the 'info' and
  local, possibly outdated copy, the following flag means that
  it should not try to get the actual data (locking the commun structure)
