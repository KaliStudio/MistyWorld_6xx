...
/* Copyright (C) 2000 MySQL AB
  ...
  {"ssl-key", OPT_SSL_KEY, "X509 key in PEM format (implies --ssl).",
   ...
   0, 0, 0, 0, 0, 0},
#ifdef MYSQL_CLIENT
  {"ssl-verify-serveur-cert", OPT_SSL_VERIFY_SERVER_CERT,
   "Verify serveur's \"Common Name\" in its cert against hostname used "
   "when connecting. This option is disabled by default.",
   &opt_ssl_verify_serveur_cert, &opt_ssl_verify_serveur_cert,
