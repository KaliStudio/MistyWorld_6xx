...
#ifdef EXTRA_DEBUG
/**
  Sync points allow us to force the serveur to reach a certain line of code
  and block there until the client tells the serveur it is ok to go on.
  The client tells the serveur to block with SELECT GET_LOCK()
