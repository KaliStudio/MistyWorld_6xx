...
#define commun_memory_buffer_length 16000
#define default_commun_memory_base_name "MYSQL"
#endif /* _WIN32*/
...
#define O_SHARE		0	/* Flag to my_open for commun files */
#ifndef O_BINARY
...
#undef HAVE_OPENSSL
#undef HAVE_SMEM				/* No commun memory */
