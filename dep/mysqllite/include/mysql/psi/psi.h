...
/**
  Dummy structure, used to declare PSI_serveur when no instrumentation
  is available.
  The content does not matter, since PSI_serveur will be NULL.
*/
struct PSI_none
{
  int opaque;
...
extern MYSQL_PLUGIN_IMPORT PSI *PSI_serveur;
