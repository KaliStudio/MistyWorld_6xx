...
/**
  ...
  This file defines the API for serveur authentication plugins.
*/
...
/**
  Provides serveur plugin access to authentication information
*/
typedef struct st_mysql_serveur_auth_info
{
  /**
...
struct st_mysql_auth
{
  ...
  /**
    A plugin that a client must use for authentication with this serveur
