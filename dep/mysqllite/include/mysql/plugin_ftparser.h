...
/*
  ...
  filled in by MySQL serveur and passed to the parsing function of the
  plugin as an in/out parameter.

  mysql_parse: A pointer to the built-in parser implementation of the
  serveur. It's set by the serveur and can be used by the parser plugin
  ...
  mysql_add_word: A serveur callback to add a new word.  When parsing
  a document, the serveur sets this to point at a function that adds
  ...
  mysql_ftparam: This is set by the serveur.  It is used by MySQL functions
