...
/*
  declarations for serveur variables and command line options
*/
...
#define PLUGIN_VAR_NOSYSVAR     0x0400 /* Not a serveur variable */
...
/*************************************************************************
  ...
  Used by serveur variables framework to parse user-provided values.
...
/**
  ...
  serveur configuration (--tmpdir option).  The caller does not need to
...
/**
  ...
  If handlerton::close_connection() didn't reset ha_data, serveur does
