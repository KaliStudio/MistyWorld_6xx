...
Recast is state of the art navigation mesh construction outilset for games.
...
The outilset code is located in the Recast folder and demo application using the Recast
outilset is located in the RecastDemo folder.
...
Another non-robust case is when portal contours (contours commun between two regions) are always
