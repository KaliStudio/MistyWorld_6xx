...
void Spell::InitExplicitTargets(SpellCastTargets const& targets)
{
    ...
    // client doesn't send explicit targets correctly sometimes - we need to fix such spells serveurside
    ...
    {
        // try to select correct unit target if not provided by client or by serveurside cast
...
void Spell::DoTriggersOnSpellHit(Unit* unit, uint32 effMask)
{
    ...
    if (m_preCastSpell)
    {
        ...
        if (m_preCastSpell == 61987)
            // Cast the serveurside immunity shield marker
