...
void LoadRandomEnchantmentsTable()
{
    ...
    if (result)
    {
        ...
        TC_LOG_INFO("serveur.loading", ">> Loaded %u Item Enchantment definitions in %u ms", count, GetMSTimeDiffToNow(oldMSTime));
    }
    else
        TC_LOG_ERROR("serveur.loading", ">> Loaded 0 Item Enchantment definitions. DB table `item_enchantment_template` is empty.");
}
