...
#define MAX_MONEY_AMOUNT               (UI64LIT(9999999999)) // TODO: Move this restriction to worldserveur.conf, default to this value, hardcap at uint64.max
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        */
        ...
        void SetTarget(uint64 /*guid*/) OVERRIDE { } /// Used for serveurside target changes, does not apply to players
