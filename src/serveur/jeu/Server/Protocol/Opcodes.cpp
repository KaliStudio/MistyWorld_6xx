...
OpcodeTable serveurOpcodeTable;
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
	...
	DEFINE_OPCODE_HANDLER(CMSG_PETITION_SHOWLIST,				   0x037B, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandlePetitionShowListOpcode       ); // 5.4.8 18414
