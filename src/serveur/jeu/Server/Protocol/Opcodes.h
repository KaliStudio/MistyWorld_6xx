...
enum SessionStatus
{
    ...
    STATUS_NEVER,                                           // Opcode not accepted from client (deprecated or serveur side only)
...
extern OpcodeTable serveurOpcodeTable;
...
{
    OpcodeTable& table = isServerOpcode ? serveurOpcodeTable : clientOpcodeTable;
