...
enum AreaFlags
{
    ...
    AREA_FLAG_CONTESTED_AREA   = 0x00040000,                // On PvP serveurs these areas are considered contested, even though the zone it is contained in is a Horde/Alliance territory.
