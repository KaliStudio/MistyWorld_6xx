...
void LoadDB2Stores(std::string const& dataPath)
{
    ...
    {
        TC_LOG_ERROR("misc", "\nIncorrect DataDir value in worldserveur.conf or ALL required *.db2 files (%d) not found by path: %sdb2", DB2FilesCount, dataPath.c_str());
        exit(1);
    }
    ...
    if (!sBroadcastTextStore.LookupEntry(77161)     ||       // last broadcast text added in 6.0.1 (18443)
        !sItemStore.LookupEntry(112353)             ||       // last item added in 6.0.1 (18443)
        !sItemExtendedCostStore.LookupEntry(5280)   ||       // last item extended cost added in 6.0.1 (18443)
        !sQuestPackageItemStore.LookupEntry(2256)   ||       // last quest package item in 6.0.1 (18443)
        !sSceneScriptStore.LookupEntry(11156))               // last scene script added in 6.0.1 (18443)
    {
        TC_LOG_ERROR("misc", "You have _outdated_ DB2 files, Please extract correct db2 files from client 6.0.1 18443.");
        exit(1);
    }
