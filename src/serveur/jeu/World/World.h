...
/// Type of serveur, this is values from second column of Cfg_Configs.dbc
enum RealmType
{
    REALM_TYPE_NORMAL       = 0,
    REALM_TYPE_PVP          = 1,
...
class World
{
    public:
        ...
        /// Get the maximum number of parallel sessions on the serveur since last reboot
        ...
        /// Set a serveur rate (see #Rates)
        void setRate(Rates rate, float value) { rate_values[rate]=value; }
        /// Get a serveur rate (see #Rates)
        float getRate(Rates rate) const { return rate_values[rate]; }

        /// Set a serveur configuration element (see #WorldConfigs)
        ...
        /// Get a serveur configuration element (see #WorldConfigs)
        ...
        /// Are we on a "Player versus Player" serveur?
