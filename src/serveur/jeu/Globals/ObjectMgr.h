...
#define MAX_INTERNAL_PLAYER_NAME 15                         // max serveur internal player name length (> MAX_PLAYER_NAME for support declined names)
...
class ObjectMgr
{
    ...
    public:
        ...
        */
        ...
        {
            TC_LOG_INFO("serveur.loading", "Loading GO Start Quest Data...");
            LoadGameobjectQuestStarters();
            TC_LOG_INFO("serveur.loading", "Loading GO End Quest Data...");
            LoadGameobjectQuestEnders();
            TC_LOG_INFO("serveur.loading", "Loading Creature Start Quest Data...");
            LoadCreatureQuestStarters();
            TC_LOG_INFO("serveur.loading", "Loading Creature End Quest Data...");
        ...
        void ReturnOrDeleteOldMails(bool serveurUp);
