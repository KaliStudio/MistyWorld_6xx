...
MovementStatusElements const PlayerMove[] = // 6.0.1 18443
{
    MSEHasPitch,               // 112
    MSEHasGuidByte2,           // 18
    MSEZeroBit,                // 148
...
MovementStatusElements const MovementFallLand[] = // 6.0.1 18443
{
    MSEPositionY,              // 40
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
...
MovementStatusElements const MovementHeartBeat[] = // 6.0.1 18443
{
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
    MSEPositionY,              // 40
...
MovementStatusElements const MovementJump[] = // 6.0.1 18443
{
    MSEPositionY,              // 40
    MSEPositionX,              // 36
    MSEPositionZ,              // 44
...
MovementStatusElements const MovementSetFacing[] = // 6.0.1 18443
{
    MSEPositionY,              // 40
    MSEPositionX,              // 36
    MSEPositionZ,              // 44
...
MovementStatusElements const MovementSetPitch[] = // 6.0.1 18443
{
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
    MSEPositionY,              // 40
...
MovementStatusElements const MovementStartBackward[] = // 6.0.1 18443
{
    MSEPositionY,              // 40
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
...
MovementStatusElements const MovementStartForward[] = // 6.0.1 18443
{
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
    MSEPositionY,              // 40
...
MovementStatusElements const MovementStartStrafeLeft[] = // 6.0.1 18443
{
    MSEPositionY,              // 40
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
...
MovementStatusElements const MovementStartStrafeRight[] = // 6.0.1 18443
{
    MSEPositionY,              // 40
    MSEPositionX,              // 36
    MSEPositionZ,              // 44
...
MovementStatusElements const MovementStartTurnLeft[] = // 6.0.1 18443
{
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
    MSEPositionY,              // 40
...
MovementStatusElements const MovementStartTurnRight[] = // 6.0.1 18443
{
    MSEPositionX,              // 36
    MSEPositionZ,              // 44
    MSEPositionY,              // 40
...
MovementStatusElements const MovementStop[] = // 6.0.1 18443
{
    MSEPositionX,              // 36
    MSEPositionY,              // 40
    MSEPositionZ,              // 44
...
MovementStatusElements const MovementStopStrafe[] = // 6.0.1 18443
{
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
    MSEPositionY,              // 40
...
MovementStatusElements const MovementStopTurn[] = // 6.0.1 18443
{
    MSEPositionX,              // 36
    MSEPositionZ,              // 44
    MSEPositionY,              // 40
...
MovementStatusElements const MovementStartAscend[] = // 6.0.1 18443
{
    MSEPositionY,              // 40
    MSEPositionX,              // 36
    MSEPositionZ,              // 44
...
MovementStatusElements const MovementStartDescend[] = // 6.0.1 18443
{
    MSEPositionX,              // 36
    MSEPositionY,              // 40
    MSEPositionZ,              // 44
...
MovementStatusElements const MovementStartSwim[] = // 6.0.1 18443
{
    MSEPositionX,              // 36
    MSEPositionY,              // 40
    MSEPositionZ,              // 44
...
MovementStatusElements const MovementStopSwim[] = // 6.0.1 18443
{
    MSEPositionX,              // 36
    MSEPositionZ,              // 44
    MSEPositionY,              // 40
...
MovementStatusElements const MovementStopAscend[] = // 6.0.1 18443
{
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
    MSEPositionY,              // 40
...
MovementStatusElements const MovementStopPitch[] = // 6.0.1 18443
{
    MSEPositionY,              // 40
    MSEPositionX,              // 36
    MSEPositionZ,              // 44
...
MovementStatusElements const MovementStartPitchDown[] = // 6.0.1 18443
{
    MSEPositionZ,              // 44
    MSEPositionY,              // 40
    MSEPositionX,              // 36
...
MovementStatusElements const MovementStartPitchUp[] = // 6.0.1 18443
{
    MSEPositionY,              // 40
    MSEPositionZ,              // 44
    MSEPositionX,              // 36
...
MovementStatusElements const MoveSetRunSpeed[] = // 6.0.1 18443
{
    MSEHasGuidByte1,
    MSEHasGuidByte7,
    MSEHasGuidByte4,
...
MovementStatusElements const MoveSetFlightSpeed[] = //6.0.1 18443
{
    MSEExtraElement,
    MSEUintCount,
    MSEHasGuidByte6,
...
MovementStatusElements const MoveSetCanFly[] = // 6.0.1 18443
{
    MSEHasGuidByte6,
    MSEHasGuidByte1,
    MSEHasGuidByte4,
...
MovementStatusElements const MoveUnsetCanFly[] = // 6.0.1 18443
{
    MSEHasGuidByte6,
    MSEHasGuidByte5,
    MSEHasGuidByte0,
...
MovementStatusElements const MoveRoot[] = // 6.0.1 18443
{
    MSEHasGuidByte0,
    MSEHasGuidByte3,
    MSEHasGuidByte4,
...
MovementStatusElements const MoveUnroot[] = // 6.0.1 18443
{
    MSEHasGuidByte3,
    MSEHasGuidByte5,
    MSEHasGuidByte7,
...
Movement::PacketSender::PacketSender(Unit* unit, Opcodes serveurControl, Opcodes playerControl, Opcodes broadcast /*= SMSG_PLAYER_MOVE*/, ExtraMovementStatusElement* extras /*= NULL*/)
