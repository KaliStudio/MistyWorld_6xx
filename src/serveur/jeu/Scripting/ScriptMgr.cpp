...
void ScriptMgr::Initialize()
{
    ...
    TC_LOG_INFO("serveur.loading", "Loading C++ scripts");

    FillSpellSummary();
    AddScripts();

    TC_LOG_INFO("serveur.loading", ">> Loaded %u C++ scripts in %u ms", GetScriptCount(), GetMSTimeDiffToNow(oldMSTime));
}
