...
class boss_algalon_the_observeur : public CreatureScript
{
    public:
        boss_algalon_the_observeur() : CreatureScript("boss_algalon_the_observeur") { }

        struct boss_algalon_the_observeurAI : public BossAI
        {
            boss_algalon_the_observeurAI(Creature* creature) : BossAI(creature, BOSS_ALGALON)
            {
                _firstPull = true;
                _fedOnTears = false;
            }
        ...
        {
            return GetUlduarAI<boss_algalon_the_observeurAI>(creature);
        }
};
...
void AddSC_boss_algalon_the_observeur()
{
    new boss_algalon_the_observeur();
