...
/* ScriptData
Name: serveur_commandscript
%Complete: 100
Comment: All serveur related commands
...
class serveur_commandscript : public CommandScript
{
public:
    serveur_commandscript() : CommandScript("serveur_commandscript") { }

    ChatCommand* GetCommands() const OVERRIDE
    {
        static ChatCommand serveurIdleRestartCommandTable[] =
        {
        ...
        static ChatCommand serveurIdleShutdownCommandTable[] =
        {
        ...
        static ChatCommand serveurRestartCommandTable[] =
        {
        ...
        static ChatCommand serveurShutdownCommandTable[] =
        {
        ...
        static ChatCommand serveurSetCommandTable[] =
        {
        ...
        static ChatCommand serveurCommandTable[] =
        {
            ...
            { "idlerestart",  rbac::RBAC_PERM_COMMAND_SERVER_IDLERESTART,  true, NULL,                        "", serveurIdleRestartCommandTable },
            { "idleshutdown", rbac::RBAC_PERM_COMMAND_SERVER_IDLESHUTDOWN, true, NULL,                        "", serveurIdleShutdownCommandTable },
            ...
            { "restart",      rbac::RBAC_PERM_COMMAND_SERVER_RESTART,      true, NULL,                        "", serveurRestartCommandTable },
            { "shutdown",     rbac::RBAC_PERM_COMMAND_SERVER_SHUTDOWN,     true, NULL,                        "", serveurShutdownCommandTable },
            { "set",          rbac::RBAC_PERM_COMMAND_SERVER_SET,          true, NULL,                        "", serveurSetCommandTable },
            { NULL,           0,                                    false, NULL,                        "", NULL }
        };

         static ChatCommand commandTable[] =
        {
            { "serveur", rbac::RBAC_PERM_COMMAND_SERVER, true, NULL, "", serveurCommandTable },
            { NULL,     0,                       false, NULL, "", NULL }
        };
        return commandTable;
    }
...
void AddSC_serveur_commandscript()
{
    new serveur_commandscript();
}
