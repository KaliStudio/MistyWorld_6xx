...
class spell_pvp_trinket_wotf_commun_cd : public SpellScriptLoader
{
    public:
        spell_pvp_trinket_wotf_commun_cd() : SpellScriptLoader("spell_pvp_trinket_wotf_commun_cd") { }

        class spell_pvp_trinket_wotf_commun_cd_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_pvp_trinket_wotf_commun_cd_SpellScript);
            ...
            void Register() OVERRIDE
            {
                AfterCast += SpellCastFn(spell_pvp_trinket_wotf_commun_cd_SpellScript::HandleScript);
            }
        };

        SpellScript* GetSpellScript() const OVERRIDE
        {
            return new spell_pvp_trinket_wotf_commun_cd_SpellScript();
        }
};
...
void AddSC_generic_spell_scripts()
{
    ...
    new spell_pvp_trinket_wotf_commun_cd();
