...
CREATE TABLE `realmlist` (
  ...
  `gamebuild` int(10) unsigned NOT NULL DEFAULT '18443',
  PRIMARY KEY (`id`),
...
INSERT INTO `realmlist` VALUES (1,'Skyfire MoP','127.0.0.1','127.0.0.1','255.255.255.0',8085,1,0,1,0,0,18443);
