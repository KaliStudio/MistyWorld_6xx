...
DELETE FROM `command` WHERE `name` IN (
  'serveur exit',
  'serveur idleshutdown',
  'serveur idleshutdown cancel',
  'serveur idlerestart',
  'serveur idlerestart cancel',
  'serveur restart',
  'serveur restart cancel',
  'serveur shutdown',
  'serveur shutdown cancel'
);

INSERT INTO `command` (`name`, `security`, `help`) VALUES
('serveur exit',4,'Syntax: .serveur exit\r\n\r\nTerminate trinity-core NOW. Exit code 0.'),
('serveur idleshutdown',3,'Syntax: .serveur idleshutdown #delay [#exist_code]\r\n\r\nShut the serveur down after #delay seconds if no active connections are present (no players). Use #exist_code or 0 as program exist code.'),
('serveur idleshutdown cancel',3,'Syntax: .serveur idleshutdown cancel\r\n\r\nCancel the restart/shutdown timer if any.'),
('serveur idlerestart',3,'Syntax: .serveur idlerestart #delay\r\n\r\nRestart the serveur after #delay seconds if no active connections are present (no players). Use #exist_code or 2 as program exist code.'),
('serveur idlerestart cancel',3,'Syntax: .serveur idlerestart cancel\r\n\r\nCancel the restart/shutdown timer if any.'),
('serveur restart',3,'Syntax: .serveur restart #delay\r\n\r\nRestart the serveur after #delay seconds. Use #exist_code or 2 as program exist code.'),
('serveur restart cancel',3,'Syntax: .serveur restart cancel\r\n\r\nCancel the restart/shutdown timer if any.'),
('serveur shutdown',3,'Syntax: .serveur shutdown #delay [#exist_code]\r\n\r\nShut the serveur down after #delay seconds. Use #exist_code or 0 as program exist code.'),
('serveur shutdown cancel',3,'Syntax: .serveur shutdown cancel\r\n\r\nCancel the restart/shutdown timer if any.');
