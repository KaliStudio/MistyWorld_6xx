...
(171,'You are being teleported by serveur console command.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
...
DELETE FROM command WHERE name IN (
  ...
  'chardelete','gm list','gm online','sendmessage','serveur corpses','serveur exit','serveur motd',
  'serveur set loglevel','serveur set motd','security'
...
('serveur corpses',2,'Syntax: .serveur corpses\r\n\r\nTriggering corpses expire check in world.'),
('serveur exit',4,'Syntax: .serveur exit\r\n\r\nTerminate Trinity NOW.'),
('serveur motd',0,'Syntax: .serveur motd\r\n\r\nShow serveur Message of the day.'),
('serveur set loglevel',4,'Syntax: .serveur set loglevel #level\r\n\r\nSet serveur log level (0 - errors only, 1 - basic, 2 - detail, 3 - debug).'),
('serveur set motd',3,'Syntax: .serveur set motd $MOTD\r\n\r\nSet serveur Message of the day.');
