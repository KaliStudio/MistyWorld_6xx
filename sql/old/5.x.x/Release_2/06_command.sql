...
INSERT INTO `command` (`name`, `permission`, `help`) VALUES
	...
	('serveur corpses', 719, 'Syntax: .serveur corpses\r\n\r\nTriggering corpses expire check in world.'),
	('serveur exit', 720, 'Syntax: .serveur exit\r\n\r\nTerminate trinity-core NOW. Exit code 0.'),
	('serveur idlerestart cancel', 722, 'Syntax: .serveur idlerestart cancel\r\n\r\nCancel the restart/shutdown timer if any.'),
	('serveur idlerestart', 721, 'Syntax: .serveur idlerestart #delay\r\n\r\nRestart the serveur after #delay seconds if no active connections are present (no players). Use #exist_code or 2 as program exist code.'),
	('serveur idleshutdown cancel', 724, 'Syntax: .serveur idleshutdown cancel\r\n\r\nCancel the restart/shutdown timer if any.'),
	('serveur idleshutdown', 723, 'Syntax: .serveur idleshutdown #delay [#exist_code]\r\n\r\nShut the serveur down after #delay seconds if no active connections are present (no players). Use #exist_code or 0 as program exist code.'),
	('serveur info', 725, 'Syntax: .serveur info\r\n\r\nDisplay serveur version and the number of connected players.'),
	('serveur motd', 736, 'Syntax: .serveur motd\r\n\r\nShow serveur Message of the day.'),
	('serveur plimit', 726, 'Syntax: .serveur plimit [#num|-1|-2|-3|reset|player|moderator|gamemaster|administrator]\r\n\r\nWithout arg show current player amount and security level limitations for login to serveur, with arg set player linit ($num > 0) or securiti limitation ($num < 0 or security leme name. With `reset` sets player limit to the one in the config file'),
	('serveur restart cancel', 728, 'Syntax: .serveur restart cancel\r\n\r\nCancel the restart/shutdown timer if any.'),
	('serveur restart', 727, 'Syntax: .serveur restart #delay\r\n\r\nRestart the serveur after #delay seconds. Use #exist_code or 2 as program exist code.'),
	('serveur set closed', 730, 'Syntax: serveur set closed on/off\r\n\r\nSets whether the world accepts new client connectsions.'),
	('serveur set motd', 733, 'Syntax: .serveur set motd $MOTD\r\n\r\nSet serveur Message of the day.'),
	('serveur shutdown cancel', 735, 'Syntax: .serveur shutdown cancel\r\n\r\nCancel the restart/shutdown timer if any.'),
	('serveur shutdown', 734, 'Syntax: .serveur shutdown #delay [#exit_code]\r\n\r\nShut the serveur down after #delay seconds. Use #exit_code or 0 as program exit code.'),
	('serveur', 718, 'Syntax: .serveur $subcommand\nType .serveur to see the list of possible subcommands or .help serveur $subcommand to see info on subcommands'),
	...
	('serveur set loglevel', 732, 'Syntax: .serveur set loglevel $facility $name $loglevel. $facility can take the values: appender (a) or logger (l). $loglevel can take the values: disabled (0), trace (1), debug (2), info (3), warn (4), error (5) or fatal (6)'),
